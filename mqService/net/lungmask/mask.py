import numpy as np
import torch
from net.lungmask import utils
import SimpleITK as sitk
from net.lungmask.resunet import UNet
import warnings
import sys
import skimage
import logging
...
def apply(image, model, device, batch_size=20, volume_postprocessing=True, noHU=False):
...
def get_model(modeltype='unet', modelname='R231', modelpath=None, n_classes=3):
